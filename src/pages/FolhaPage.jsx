...
export default function FolhaPage() {
  ...
  const paginatedFolhas = folhas.slice((paginaAtual - 1) * PAGE_SIZE, paginaAtual * PAGE_SIZE);
  ...
  return (
    <div>
      ...
      <div className="bg-white border border-stone-200 rounded-xl overflow-hidden">
        ...
        {!loading && folhas.length > 0 && <Pagination page={paginaAtual} totalPages={totalPaginas} totalItems={folhas.length} pageSize={PAGE_SIZE} onPageChange={setPagina} />}
      </div>
