...
import { ComboSelect, EmptyState, Field, LoadingRows, Modal, PageHeader, PrimaryButton, SecondaryButton, Pagination, inputCls } from '../components/ui';
...
export default function NotasFiscaisPage({ user }) {
  ...
  const paginatedNotas = notas.slice((paginaAtual - 1) * PAGE_SIZE, paginaAtual * PAGE_SIZE);
  ...
  return (
    <div>
      ...
      <div className="bg-white border border-stone-200 rounded-xl overflow-hidden">
        ...
        {!loading && notas.length > 0 && <Pagination page={paginaAtual} totalPages={totalPaginas} totalItems={notas.length} pageSize={PAGE_SIZE} onPageChange={setPagina} />}
      </div>
